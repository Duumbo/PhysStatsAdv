...
% subsection Clebsh-Gordan (end)
\subsection{Couplage Spin-Orbite} % (fold)
...
% subsection Couplage Spin-Orbite (end)

\subsection{Atome dans un Champ Magnétique} % (fold)
\label{sub:Atome dans un Champ Magnétique}

Pour traiter de ce problème, nous allons utiliser le Hamiltonien suivant
\begin{align}
...
% subsection Atome dans un Champ Magnétique (end)
